...
TEST_CASE("Conditions", "[Framework][Conditions]") {
  ...
  SECTION("Testing python static") {
    const char* cfg =
        ...
        "p.testMode=True\n"
        "columns=['A','B','C']\n"
        "cop=SimpleCSVTableProvider.SimpleCSVIntegerTableProvider("
        "'test_table_python',columns)\n"
  ...
  SECTION( "Testing HTTP loading" ) {
    const char* cfg = 
        ...
        "columns=[\"A\",\"Q\",\"V\"]\n"
        "cop=SimpleCSVTableProvider."
        "SimpleCSVDoubleTableProvider(\"test_table_http\",columns)\n"
        "cop.validForever("
        "\"http://webusers.physics.umn.edu/~jmmans/test_table.csv\")\n";
